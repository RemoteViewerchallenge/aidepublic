...
export default function RoleManager({ savedRoles, setSavedRoles }: RoleManagerProps) {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1>🎭 Role Manager</h1>
        <button onClick={() => setIsCollapsed(!isCollapsed)} style={{ padding: '5px 10px', cursor: 'pointer' }}>
