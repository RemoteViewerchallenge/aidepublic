...
import { Role } from '../app/role-manager/RoleManager';
...
export default function ModelAssigner({ role, models }: ModelAssignerProps) {
  ...
  return (
    <div style={{ border: '1px solid #ddd', padding: '10px', borderRadius: '8px', marginTop: '10px', background: '#f9f9f9' }}>
      ...
      {assignedModel ? (
        ...
        <p style={{ margin: 0, fontStyle: 'italic', color: '#666' }}>No model assigned.</p>
      )}
    </div>
  );
}