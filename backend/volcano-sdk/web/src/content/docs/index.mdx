...
Define specialized agents with roles and let the LLM coordinator automatically route work to the right agent. Like automatic tool selection, but for agents—no manual orchestration needed!
