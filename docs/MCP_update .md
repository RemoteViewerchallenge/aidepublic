Here's a focused explanation of how the stdio adapter works, why your registration/handshake behavior looked the way it did, and exactly what to change if you want "code mode" (prompts/tools) behavior to work.
